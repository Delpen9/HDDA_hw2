...
The best denoising technique for removing gaussian noise is the gaussian denoise.\newline%
        The gaussian denoise performs the inverse operation of the gaussian noise, thus resulting in the best result.%
The best denoising technique is the median filter. The median filter is superior because all mean filters will preserve information on the salt{-}and{-}pepper noise;\newline%
